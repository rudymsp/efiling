					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="jenis_file">
								...
								<?php 
								$kd_cat   =   $this->db->get('efiling_kategori_doc' )->result_array();
...
<script type="text/javascript">
	const ala = document.getElementById('alamat').value;
	const  target  = document.querySelector('.validate');
	...
	el.setAttribute('name', 'alamat');
	el.setAttribute('value', ala.replace('-','/'));
