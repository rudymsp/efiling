<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <!-- <a class="navbar-brand" href="<?php echo base_url();?>doku/Dokumentasi">Filling</a> -->
    </div>
      ...
      <ul class="nav navbar-nav">
        <!-- <li class="">
          <?php if ($this->uri->segment(3) == 'mimin') {
                  ...
                  echo '<a href="'.base_url('doku/Dokumentasi/mimin').'" >Manage File</a>';  
                }  else {
                    echo '';
                }
          ;?> 
...
<!--         <li><a href="<?php echo base_url(); ?>quiz">Quiz</a></li>
 -->        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo 'http://localhost/e-matchad/'; ?>Ebank">Dashboard</a></li> 
            <li><a href="<?php echo 'http://localhost/efiling/'; ?>#files">Management Folder</a></li>
            <!-- <?php if ($this->session->userdata('level') == 1): ?> -->
                
            <!-- <?php endif ?> -->
            <li><a href="<?php echo 'http://localhost/e-matchad/'; ?>login/logout">Logout</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
