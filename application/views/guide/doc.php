    	...
    	$tabs_content .= '
	    		...
	    		<div class="o-flag o-flag--huge u-mrgn-bottom--6" style="border-bottom:dotted grey 2px; padding-bottom:10px;">
	                ...
	                <div class="o-flag__body">
	                    ...
	                    <a href="'.base_url().$rowi->alamat_file.'/'.$rowi->nama_file.'" target="_blank">'.$jenis.'</a>
	                    </div>
...
<section class="o-container o-container--responsive o-container--guide u-mrgn-bottom--10">
    <h1 class="u-txt--xxlarge u-txt--normal u-mrgn-top--10 u-mrgn-bottom--10 u-align-center" style="text-transform: uppercase; font-family: 'Bungee', cursive;">Filling Sistem</h1>
